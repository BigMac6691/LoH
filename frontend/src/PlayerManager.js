...
export class PlayerManager
{
  ...
  addPlayer(name, color, ai = false)
  {
    ...
    console.log(
      `Player ${player.name} would normally be created and assigned to a star at this point`
    );
  ...
  removePlayer(playerId)
  {
    ...
    // Remove player's star ownership (if they had one)
    if (player.star)
    {
  ...
  clearPlayers()
  {
    // Reset all stars to unowned (if players had stars)
